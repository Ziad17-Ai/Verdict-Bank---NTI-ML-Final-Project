...
need the staff access code `AURION-STAFF-2026` (change this in `app.py`,
...
├── models.py                # Loads the 4 .pkl files, exposes predict_* functions
├── db.py                    # SQLite schema + connection helper
├── seed.py                  # Demo data on first run
├── requirements.txt
├── models/                  # your original .pkl files
├── data/                    # aurion_bank.db (created on first run)
├── templates/                # welcome.html, client.html, manager.html
└── static/
    ├── css/style.css        # design system (your color palette)
    └── js/                   # api.js, app_shell.js, welcome.js, client.js, manager.js
```
